...
<title>fresho apple-washington</title>
</head>
<style>
#slider-text h2 {
...
select {width:160px;text-align:center; }
select .lt { text-align:center; }
select { text-indent: 5px; }

#carousel carousel-showmanymoveone slide:hover { -moz-box-shadow: 0 0 40px #ccc; -webkit-box-shadow: 0 0 40px #ccc; box-shadow: 0 0 40px #ccc; }
 ...
 (function ($, window, document, undefined) {
    ...
    GlassCase.prototype = {
        init: function (options) {
            ...
            gcBase.gcThumbsLi = gcBase.gcThumbsUl.find('li');
            gcBase.gcThumbsImg = gcBase.gcThumbsLi.find('ui:image');
            ...
            var altTxt = gcBase.gcThumbsLi.eq(gcBase.current).find('ui:image').attr('alt');
				    ...
				    gcBase.gcThumbsImg.each(function (index) {
                        ...
                        .on('load', function () {
                            var lWidth = this.width,
                                ...
                                index = gcBase.gcThumbsLi.find("ui:image[src*='" + $(this).attr('src') + "']").parents('li').index();
                            gcBase.gcImageData[index] = lGCImageData;
                            gcBase.processThumbImage(index);
                            if (++countLoadedImages === countTotalImages) { dfd.resolve(); }
                        })
                        .on('error', function () {
                            var index = gcBase.gcThumbsLi.find("ui:image[src*='" + $(this).attr('src') + "']").parents('li').index(),
        ...
        update: function () {
            ...
            //2.
            altTxt = gcBase.gcThumbsLi.eq(gcBase.current).find('ui:image').attr('alt');
            if (altTxt === undefined) altTxt = 'image';

            gcBase.gcDisplayDisplay.attr('src', gcBase.gcThumbsLi.eq(gcBase.current).find('ui:image').attr('src'))
                                   .attr('alt', altTxt);
...
<div class="container">
       ...
       <li> <img src="<ui:image img='${product.productImg}'></ui:image>" alt="Text" data-gc-caption="FRESH APPLE"/></li>
		...
		<div class="col-md-6">
   	    <div class="major">
			...
			<div class="product-desc">${product.productCategory}</div>
			<hr>
			...
			<input min="1" type="number" id="quantity" name="quantity" value="1" />
         	<style>#quantity { padding:2px; width:60px; border: 1px solid #555; }</style>
        				<button class="btn" qa="add" type="button">
...
<div class="container-fluids">		
		<div class="col-md-12 product-info">
			...
			<li class="active"><a href="#service-one" data-toggle="tab">PRODUCT DESCRIPTION</a></li>
			<li><a href="#service-two" data-toggle="tab">PRODUCT BENEFITS</a></li>
			</ul>
			...
			<div class="tab-pane fade" id="service-two">
						<section class="container product_benefits">
								 The phytonutrients and antioxidants in apples may help reduce the risk of developing cancer, hypertension, diabetes, and heart disease. It can potentially improve neurological health that prevents dementia, lower levels of bad cholesterol. 
						</section>
...
<div class="container-new">
  <div class="row" id="slider-text">
    <div class="col-md-6" >
      <h2>People who bought Fresho Apple - Washington Also Bought</h2>
    </div>
  </div>
</div>
<br><br>
 ...
 <c:forEach items="${sameCategoryProduct}" var="product" varStatus="itr">
          <div class="item">
              
            <div class="col-xs-12 col-sm-6 col-md-2">
        
              <a href="#"><img src="<ui:image img='${product.productImg}'></ui:image>" alt="Text" data-gc-caption="FRESH APPLE"/></a><br/>
              <td><h3 class="text-center"> ${product.productName}</h3></td>
