  ...
  <div class="items">
    ...
    <img alt="" width="1" height="1"
        ...
        <div data-price="60" class="item">
            <img src="images/image/banna.png" alt="jacket" class="img-item" ></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Banana</h3>
                    <h5>Rs.60</h5>
     ...
     <br>
        ...
        <div data-price="80" class="item">
            <img src="images/image/grapes.png" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                  <h3>Grapes</h3>
                    <h5>Rs.80</h5>
    ...
    <br>
         ...
         <div data-price="120" class="item">
            <img src="images/image/oranges.png" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Fresh Oranges</h3>
                    <h5>Rs.120</h5>
     ...
     <br>
         ...
         <div data-price="100" class="item">
            <img src="images/image/Papaya.png" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Papaya</h3>
                    <h5>Rs.100</h5>
     ...
     <br>
         ...
         <div data-price="140" class="item">
            <img src="images/image/pears.png"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Pears</h3>
                    <h5>Rs.140</h5>
     ...
     <br>
         ...
         <div data-price="150" class="item">
            <img src="images/image/Pineapple.png"alt="jacket" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Pineapple</h3>
                    <h5>Rs.150</h5>
     ...
     <br>
         ...
         <div data-price="90" class="item">
            <img src="images/image/pomegranate.png"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Pomegranate</h3>
                    <h5>Rs.90</h5>
     ...
     <br>
         ...
         <div data-price="120" class="item">
            <img src="images/image/watermelon.png"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Watermelon</h3>
                    <h5>Rs.120</h5>
    ...
    <br>
         ...
         <div data-price="80" class="item">
            <img src="images/image/chikoo.png"alt="chikoo" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
              		<h3>Chikoo</h3>
                    <h5>Rs.80</h5>
     ...
     <br>
         	...
         	<strong style=" text-shadow: 1px 1px #fff;">Add to Cart </strong>
               ...
               <div data-price="60" class="item">
            <img src="images/image/melon.jpg" alt="beans" class="img-item" ></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Melon</h3>
                    <h5>Rs.15</h5>
